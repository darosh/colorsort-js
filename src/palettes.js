...
export const palettes = [
  ...
  ['#1c1718', '#45221b', '#891420', '#4e4e52', '#865f51', '#e43040', '#87878c', '#c78a55', '#ee7976', '#e4c4ad'],
  chroma.scale(['#fafa6e', '#2A4858']).mode('lch').colors(6),
  chroma.scale(['blue', 'pink']).mode('oklch').colors(8),
  ['#00f', '#0ff', '#000', '#fff', '#f00', '#0f0', '#ff0', '#f0f'],
  [
    '#000000',
    '#1D2B53',
    '#7E2553',
  ...
  ['#191520', '#2a2d3c', '#294566', '#2c6cba', '#85c4d7', '#4b7c52', '#a0b035', '#f8d877', '#ffa057', '#e93f59', '#9653a2', '#723738', '#c68c76', '#f0efdf'],
  [
    '#191520',
    '#2a2d3c',
    '#294566',
  ...
  ['#0b0b0b', '#09182f', '#2b2b2d', '#54565b', '#b15d2e', '#818387', '#9fa3a4', '#e69a28', '#f8c714', '#e7eae8'],
  ['#4f1621', '#861c36', '#a54267', '#bd3c4f', '#b26690', '#d9616e', '#e37789', '#ba8dbd', '#f18082', '#c1bbdf'],
  ['#453a4c', '#8a879b', '#b08778', '#e29a40', '#b7aebd', '#d8d7e4'],
  ['#292d3a', '#394866', '#606f85', '#bf4672', '#859e9a', '#c8c191'],
  [
    '#140c1c',
    '#442434',
    '#30346d',
  ...
  ['#e0dfe0', '#071315', '#111d07', '#1d1409', '#ce57ae', '#44298d', '#396c3c'],
  ['#f7f0e9', '#0f1510', '#e5ae76', '#3b94d8', '#acb6a5', '#d2c5d5', '#b93c34'],
  [
    '#060608',
    '#141013',
    '#3b1725',
